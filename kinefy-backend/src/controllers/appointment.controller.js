                ...
                sendEmail({
                    ...
                    html: `
                        <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                            ...
                            <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #55A98A; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Acceder a mi agenda</a></p>
                        </div>
                    `
            ...
            if (estado === 'confirmada') {
                ...
                emailHtml = `
                    <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                        ...
                        <div style="background-color: #F0FDF4; border-left: 4px solid #55A98A; padding: 16px; margin: 20px 0; border-radius: 4px;">
                            ...
                            <p style="margin: 0 0 8px 0;"><strong>Hora:</strong> ${appointment.hora}</p>
                            <p style="margin: 0;"><strong>Especialista:</strong> ${appointment.fisioterapeuta.name}</p>
                        </div>
                        <p>Recuerda acudir puntual a tu sesión de rehabilitación. ¡Te deseamos una pronta recuperación!</p>
                        <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #55A98A; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Ver mis citas</a></p>
                    </div>
                `;
                ...
                emailHtml = `
                    <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                        ...
                        <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #4A5568; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Solicitar Cita de Nuevo</a></p>
                    </div>
                `;
            }
                    ...
                    sendEmail({
                        ...
                        html: `
                            <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                                ...
                                <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #4A5568; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Acceder a mi agenda</a></p>
                            </div>
                        `
                    ...
                    sendEmail({
                        ...
                        html: `
                            <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                                ...
                                <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #EF4444; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Solicitar Nueva Cita</a></p>
                            </div>
                        `
                ...
                sendEmail({
                    ...
                    html: `
                        <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                            ...
                            <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #3182CE; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Acceder a mi agenda</a></p>
                        </div>
                    `
                    ...
                    sendEmail({
                        ...
                        html: `
                            <div style="font-family: sans-serif; color: #1A2E35; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 8px; padding: 24px;">
                                ...
                                <p style="margin-bottom: 0;"><a href="http://localhost" style="display: inline-block; background-color: #D69E2E; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">Ver mis citas</a></p>
                            </div>
                        `
