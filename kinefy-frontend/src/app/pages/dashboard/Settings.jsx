                        ...
                        <form onSubmit={handleSaveSecurity} className="settings-form">
                            <div className="settings-form__group">
                                ...
                                <div className="settings-form__input-wrapper">
                                    ...
                                    <button
                                        type="button"
                                        className="settings-form__visibility-toggle"
                                        onClick={() => setShowCurrentPassword(!showCurrentPassword)}
                                        aria-label={showCurrentPassword ? "Ocultar contraseña" : "Mostrar contraseña"}
                                    >
                                        {showCurrentPassword ? (
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="settings-form__visibility-icon">
